...
TODO: plotting a t.s. as an example?
...
knitr::kable(as.data.frame(head(fit), stringsAsFactors = FALSE), 
             escape = TRUE,
             caption = "Fitted models")
```

TODO: I have not been able to display correctly the method name (when printed they appear as `<NAME>`). Maybe Claude will?
...
TODO: plot an example of a forecast?

# References

- [Package documentation](../)
- [GitHub repository](https://github.com/yourusername/fable.intermittent)
